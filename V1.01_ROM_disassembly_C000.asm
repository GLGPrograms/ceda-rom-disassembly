...
label_cdb5:
    ...
    ; GLG Programs custom code
    ; this little program moves a 'G' letter across the screen
    ; and also triggers the speaker beep
glg_main:
    ld hl, $d320
    ld b, 72
move_loop:
...
hcf:
    ...
    ; Fill the remaining gap with "nop"
