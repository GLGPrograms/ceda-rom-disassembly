...
; command line: z80dasm -g 0xc000 -t /home/giomba/Retrofficina/Sanco/ROM/V1.01_ROM.bin
	...
	ret			;c0c1	c9 	. 
	im 2		;c0c2	ed 5e 	. ^ 
	call 0c0d1h		;c0c4	cd d1 c0 	. . . 
	call 0c43fh		;c0c7	cd 3f c4 	. ? . 
	call 0c108h		;c0ca	cd 08 c1 	. . . 
	call 0c88dh		;c0cd	cd 8d c8 	. . . 
	ret			;c0d0	c9 	. 
	ld hl,0c0f1h		;c0d1	21 f1 c0 	! . . 
	ld a,(hl)			;c0d4	7e 	~ 
	inc hl			;c0d5	23 	# 
	cp 0ffh		;c0d6	fe ff 	. . 
	jr z,$+9		;c0d8	28 07 	( . 
	...
	ld a,(hl)			;c0db	7e 	~ 
	inc hl			;c0dc	23 	# 
	out (c),a		;c0dd	ed 79 	. y 
	jr $-11		;c0df	18 f3 	. . 
	in a,(0d6h)		;c0e1	db d6 	. . 
	and 007h		;c0e3	e6 07 	. . 
	ld d,000h		;c0e5	16 00 	. . 
	ld e,a			;c0e7	5f 	_ 
	add hl,de			;c0e8	19 	. 
	ld a,(hl)			;c0e9	7e 	~ 
	out (0e1h),a		;c0ea	d3 e1 	. . 
	ld a,041h		;c0ec	3e 41 	> A 
	out (0e1h),a		;c0ee	d3 e1 	. . 
	ret			;c0f0	c9 	. 
	jp po,0e205h		;c0f1	e2 05 e2 	. . . 
	djnz $-28		;c0f4	10 e2 	. . 
	ld b,c			;c0f6	41 	A 
	ex (sp),hl			;c0f7	e3 	. 
	dec b			;c0f8	05 	. 
	ex (sp),hl			;c0f9	e3 	. 
	ld bc,041e3h		;c0fa	01 e3 41 	. . A 
	pop hl			;c0fd	e1 	. 
	dec b			;c0fe	05 	. 
	rst 38h			;c0ff	ff 	. 
	xor (hl)			;c100	ae 	. 
	...
	jr nz,$-5		;c400	20 f9 	  . 
	ret			;c402	c9 	. 
	in a,(0c0h)		;c403	db c0 	. . 
	rlca			;c405	07 	. 
	jr nc,$-3		;c406	30 fb 	0 . 
	rlca			;c408	07 	. 
	jr c,$-6		;c409	38 f8 	8 . 
	ret			;c40b	c9 	. 
	...
	ret			;c414	c9 	. 
	call 0c403h		;c415	cd 03 c4 	. . . 
	ld a,c			;c418	79 	y 
	out (0c1h),a		;c419	d3 c1 	. . 
	ret			;c41b	c9 	. 
	in a,(0c0h)		;c41c	db c0 	. . 
	bit 4,a		;c41e	cb 67 	. g 
	jr nz,$-4		;c420	20 fa 	  . 
	ret			;c422	c9 	. 
	...
	push bc			;c43f	c5 	. 
	push hl			;c440	e5 	. 
	ld hl,0c45ch		;c441	21 5c c4 	! \ . 
	call 0c41ch		;c444	cd 1c c4 	. . . 
	ld c,003h		;c447	0e 03 	. . 
	call 0c415h		;c449	cd 15 c4 	. . . 
	ld c,(hl)			;c44c	4e 	N 
	inc hl			;c44d	23 	# 
